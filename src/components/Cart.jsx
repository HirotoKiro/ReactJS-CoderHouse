                        ...
                        <tbody>
                            {cart.map(item => (
                                <tr key={item.id}>
                                    ...
                                    <td className="align-middle text-end"><Link onClick={() => {removeItem(item.id)}} title={"Eliminar Producto"}><img src={"/images/cruz.png"} alt={"Eliminar Producto"} width={32} /></Link></td>
                                </tr>
                                ))
                            }
                            <tr>
